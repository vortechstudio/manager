    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="{{ route('home') }}" class="d-lg-none">
                <img alt="Logo" src="{{ asset('/storage/logos/logo_small.png') }}" class="h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                        ...
                        <span class="menu-link">
							<span class="menu-title fs-4">{!! currentUrlText() !!}</span>
                        ...
                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                            <!--begin:Menu item-->
                            @foreach($menu_head as $menu)
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="{{ $menu->url }}">
                                    <span class="menu-title">{!! $menu->translateOrDefault()->title ?? null !!}</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
